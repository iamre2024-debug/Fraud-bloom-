...
if (repeatedClaimCases.some((item) => item.generatedPacketVersion !== 8 || !item.scenarioVariantId || !item.scenarioVariant)) {
  failures.push('Repeated generated cases are missing version 8 scenario-variation metadata.');
}
