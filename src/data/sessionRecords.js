...
const sessionDetailsById = {
  ...
  'SES-9302': {
    ...
    profileActions: ['No profile change recorded'], payeeTokenActivity: ['No token change recorded in session'], moneyMovement: ['EVT-3308 · $2,400 credit-line draw request submitted before session'],
